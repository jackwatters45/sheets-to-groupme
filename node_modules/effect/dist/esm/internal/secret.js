...
export const proto = {
  ...
  [Hash.symbol]() {
    return pipe(Hash.hash(SecretSymbolKey), Hash.combine(Hash.array(this.raw)), Hash.cached(this));
  },
  [Equal.symbol](that) {
...
/** @internal */
export const fromIterable = iterable => make(ReadonlyArray.fromIterable(iterable).map(char => char.charCodeAt(0)));
/** @internal */
